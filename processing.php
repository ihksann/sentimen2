...
$data = 'datasets/2sentimen/gabungan_hasil_prediksi.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=processing&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<body>
    <h1>
        <center><b>Perbandingan Hasil Prediksi Setiap Algoritma Dalam 2 Sentimen</b></center>
    </h1> <br>
    <table>
        <tr>
            <center>
                <th>Komentar</th>
                <th>Pelabelan Leksikon</th>
                <th>Prediksi NB</th>
                <th>Prediksi SVM</th>
                <th>Prediksi LSTM</th>
            </center>
