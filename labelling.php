...
$data = 'datasets/2sentimen/labeling.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=labelling&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Hasil Labeling 2 Sentimen</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1>
        <center><b>Labeling 2 Sentimen</b></center>
    </h1> <br>
    <table>
        <tr>
            <center>
