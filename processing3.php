...
$data = 'datasets/3sentimen/gabungan_hasil_prediksi.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=processing3&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<body>
    <h1>
        <center><b>Perbandingan Hasil Prediksi Setiap Algoritma Dalam 3 Sentimen</b></center>
    </h1> <br>
    <table>
        <tr>
            <center>
