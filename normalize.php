...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=normalize&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Proses Normalization</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1>
        <center><b>Word Normalization</b></center>
    </h1> <br>
    <table>
        <tr>
            <center>
                <th>Filtering/Stopword</th>
                <th>Normalization</th>
            </center>
        </tr>
