...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=scrapping&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Proses Clean Data</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1>
        <center><b>Data Scrapping</b></center>
    </h1> <br>
    <table>
        <tr>
            <th>Username</th>
