...
$data = 'datasets/3sentimen/train_data.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=datalatih3&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Data Latih 3 Sentimen</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1><b>
            <center>Data Latih 3 Sentimen</center>
        </b></h1> <br>
    <h5>
