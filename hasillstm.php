...
$data = 'datasets/hasil_pelatihan_lstm2.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=hasillstm&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Hasil Prediksi LSTM</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1>
        <center><b>Hasil Prediksi Long Short Term Memory</b></center>
    </h1> 
    <p>
