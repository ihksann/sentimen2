...
function generatePageLink($page, $text) {
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=casefolding&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<html>
<head>
    <title>Proses Case Folding</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>
<body>
    <h1><center><b>Case Folding</b></center></h1> <br>
    <table>
        <tr>
            <th><center>Clean Data</center></th>
