...
$data = 'datasets/3sentimen/labeling.csv';
...
{
    return '<a href="' . $_SERVER['PHP_SELF'] . '?halaman=labelling3&page=' . $page . '">' . $text . '</a> ';
}
?>
...
<head>
    <title>Hasil Labeling 3 Sentimen</title>
    <link href="css/tabel.css" rel="stylesheet" />
</head>

<body>
    <h1>
        <center><b>Labeling 3 Sentimen</b></center>
    </h1> <br>
    <table>
        <tr>
            <center>
